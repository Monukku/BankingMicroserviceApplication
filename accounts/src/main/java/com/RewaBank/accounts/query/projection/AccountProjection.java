...
public class AccountProjection {
    ...
    public void on(AccountCreatedEvent event) {
        ...
        log.info("iAccountService.createAccount call from Account Projection EventHandler started...");
        iAccountsService.createAccount(accountEntity,accountEntity.getAccountType());
        log.info("iAccountService.createAccount call from Account Projection EventHandler completed");
    }
