...
@Component
@Slf4j
public class CustomersFeignClientFallback implements AccountsFeignClient {

    @Override
    public void creditAccount(UUID customerId, AccountCreditRequest request) {
        log.error("Accounts MS unavailable for credit — accountId: {}", customerId);
